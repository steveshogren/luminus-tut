...
* Update the connection parameters for the database in the `ksafe.db.core` namespace of your application.
...
Request middleware functions are located under the `ksafe.middleware` namespace.
